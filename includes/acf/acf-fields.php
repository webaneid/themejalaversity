			...
			[
				...
				'layouts'      => [
					...
					[
						...
						'sub_fields' => [
							[
								'key'           => 'field_news_label',
								'name'          => 'label',
								'label'         => __( 'Label Kecil', 'jalaversity' ),
								'type'          => 'text',
								'default_value' => __( 'Kabar Kampus', 'jalaversity' ),
								'placeholder'   => __( 'Kabar Kampus', 'jalaversity' ),
							],
							[
								'key'           => 'field_news_heading',
								'name'          => 'heading',
								'label'         => __( 'Judul Section', 'jalaversity' ),
								'type'          => 'text',
								'default_value' => __( 'Berita & Pengumuman', 'jalaversity' ),
								'placeholder'   => __( 'Berita & Pengumuman', 'jalaversity' ),
							],
						],
					],
